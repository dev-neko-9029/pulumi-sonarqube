...
rm -f provider/cmd/pulumi-resource-sonarqube/bridge-metadata.json

# Go modules & code
replace_go_src() {
  replace "${1}" pulumi-sonarqube "${upstream}"
