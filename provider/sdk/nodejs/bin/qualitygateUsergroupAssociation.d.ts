 ...
 * ```
 */
export declare class QualitygateUsergroupAssociation extends pulumi.CustomResource {
    /**
     ...
     */
    static get(name: string, id: pulumi.Input<pulumi.ID>, state?: QualitygateUsergroupAssociationState, opts?: pulumi.CustomResourceOptions): QualitygateUsergroupAssociation;
    /**
     ...
     */
    static isInstance(obj: any): obj is QualitygateUsergroupAssociation;
    /**
     * The name of the Quality Gate
     */
    readonly gatename: pulumi.Output<string>;
    /**
