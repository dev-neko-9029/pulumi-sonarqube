...
import (
	...
	sonarqube "github.com/jdamata/terraform-provider-sonarqube/sonarqube" // Import the upstream provider
...
func Provider() tfbridge.ProviderInfo {
	...
	prov := tfbridge.ProviderInfo{
		...
		Keywords:   []string{"xyz", "sonarqube", "category/cloud"},
		License:    "Apache-2.0",
	...
	prov.MustComputeTokens(tokens.SingleModule("sonarqube_", mainMod, tokens.MakeStandard(mainPkg)))
